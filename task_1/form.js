...
function render(){
  ...
  for(let i=0;i<details.length;i++){
    ...
    tr.myIndex = i;
    tr.innerHTML='<td>'+it.name+'</td><td>'+it.age+'</td><td>'+it.mail+'</td><td><div class="actions"><button class="table-btn edit-btn">Edit</button><button class="table-btn delete-btn">Delete</button></div></td>';33
